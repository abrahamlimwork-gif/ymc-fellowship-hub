...
async function run() {
    await extractPages('C:\\Users\\Khyle Alex\\Desktop\\TWNAF\\Master Mentor Workbook - May 2024.pdf', 'src/data/master_mentor_pages.json');
    await extractPages('C:\\Users\\Khyle Alex\\Desktop\\TWNAF\\TMD Mothers Workbook - April 2024.pdf', 'src/data/tmd_mothers_pages.json');
}
